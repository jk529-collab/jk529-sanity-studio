...
const allowedBlocks = (schemaName: string) => schemaName === 'sitePage'
  ? ['heroSection', 'richTextSection', 'imageSection', 'mediaGallerySection', 'callToActionSection', 'productCalloutSection', 'productGridSection', 'productDetailSection', 'cartSection', 'storeSearchSection', 'faqSection']
  : schemaName === 'article'
